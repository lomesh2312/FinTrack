  ...
  return (
    <div className='card'>
      <div className='flex items-center justify-between mb-6'>
        <div>
          <h5 className='text-[16px] font-bold text-[#000000] tracking-tight'>All Expenses</h5>
          <p className='text-[12px] text-[#9B8EC4] mt-0.5'>{transactions?.length || 0} total records</p>
        </div>
        <button id='btn-download-expense' className='card-btn' onClick={onDownload}>
      ...
      <div className='grid grid-cols-1 gap-2'>
        ...
        {(!transactions || transactions.length === 0) && (
          <div className='flex flex-col items-center justify-center py-12'>
            <p className='text-[14px] text-[#9B8EC4] font-medium'>No expense records found</p>
            <p className='text-[12px] text-[#C4B5FD] mt-1'>Add your first expense to see it here</p>
          </div>
        )}
      </div>
